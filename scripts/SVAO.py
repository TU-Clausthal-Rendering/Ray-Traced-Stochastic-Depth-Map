...
def render_graph_SVAO():
    ...
    g.create_pass('ForwardLighting', 'ForwardLighting', {})
    ...
    g.add_edge('DepthPeeling.depth2', 'SVAO.depth2')
    ...
    g.add_edge('LinearizeDepth.linearDepth', 'ReconstructNormals.linearZ')
    g.add_edge('CompressNormals.normalOut', 'Switch.i0')
    g.add_edge('ReconstructNormals.normal', 'Switch.i1')
    g.add_edge('Switch.out', 'SVAO.normals')
    ...
    g.mark_output('ReconstructNormals.normal')
    return g
